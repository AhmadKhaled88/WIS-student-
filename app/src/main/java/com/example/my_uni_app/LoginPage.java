...
public class LoginPage extends AppCompatActivity {
    ...
    Button login_button ;
    TextView Forgetten_password,academic_advisor;
    TextView Register;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        academic_advisor=findViewById(R.id.academic_advisor);
      ...
      //  academic_advisor.setOnClickListener(view ->{
       //     startActivity(new Intent(LoginPage.this,academiclogin.class));
       // });
